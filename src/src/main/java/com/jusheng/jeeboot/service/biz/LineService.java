...
public class LineService extends BaseService<BizLineMapper,BizLine> {
    public List<BizLine> findList(BizLine sysRole){
    ...
    public void save(BizLine bizLine) throws BizErrorException {
        ...
        List<BizLine> bizLineList=this.dao.selectByExample(example);

//        if(bizLineList.size()>0) throw new BizErrorException("已经有相同名称的角色，新增失败");
